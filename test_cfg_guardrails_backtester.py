...
def test_warmup_multiplier_before_warmup_days() -> None:
    ...
    row = cb._compute_cfg_guard_multipliers(
        cfg=cb.SHADOW_GUARD_CONFIGS["ramp40_025"],
        strategy_id="T01",
        capital=10_000.0,
        ...
        day_anchor=10_000.0,
        strat_pnl_history=cb._STRAT_PNL_HISTORY,
        baseline_max_risk_dollars=200.0,
    )
...
def test_cold_start_uses_strat_history_count() -> None:
    ...
    row = cb._compute_cfg_guard_multipliers(
        cfg=cb.SHADOW_GUARD_CONFIGS["cold5_025"],
        strategy_id="T02",
        capital=10_000.0,
        peak_capital=10_000.0,
...
def test_daily_loss_stop_blocks() -> None:
    assert cb._guard_daily_loss_stopped_for_cfg(
        cfg=cb.SHADOW_GUARD_CONFIGS["daily3"],
    ...
    row = cb._compute_cfg_guard_multipliers(
        ...
        day_anchor=10_000.0,
        strat_pnl_history={},
        baseline_max_risk_dollars=100.0,
    )
